...
public class LogUtil {
    ...
    public static final String TAG = "tpnet";
    ...
    private static void print(int mode, final String tag, String msg) {
        ...
        switch (mode) {
            case Log.VERBOSE:
                Log.v(buftag.toString(), msgbuf.toString());
                break;
            case Log.DEBUG:
                Log.d(buftag.toString(), msgbuf.toString());
                break;
            case Log.INFO:
                Log.i(buftag.toString(), msgbuf.toString());
                break;
            case Log.WARN:
                Log.w(buftag.toString(), msgbuf.toString());
                break;
            case Log.ERROR:
                Log.e(buftag.toString(), msgbuf.toString());
                break;
            default:
                Log.d(buftag.toString(), msg);
                break;
        }
    }
