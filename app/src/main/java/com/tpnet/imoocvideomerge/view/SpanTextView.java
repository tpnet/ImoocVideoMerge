...
public class SpanTextView extends TextView {
    ...
    public void setImageToLast(@DrawableRes int imgId, ImageSizeFlag sizeFlag, int[]... size) {
        Drawable drawable = getResources().getDrawable(imgId);
    ...
    public void setImageToFirst(@DrawableRes int imgId, ImageSizeFlag sizeFlag, int[]... size) {
        Drawable drawable = getResources().getDrawable(imgId);
    ...
    public void replaceTextToImage(String text, @DrawableRes int imgId, ImageSizeFlag sizeFlag, int[]... size) {
    ...
    public void setImage(@DrawableRes int imgId, String text, ImageFlag flag) {
        setImage(getResources().getDrawable(imgId), text, flag, ImageSizeFlag.AUTO_SIZE);
    }

    public void setImage(@DrawableRes int imgId, String text, ImageFlag flag, ImageSizeFlag sizeFlag, int[]... size) {
    ...
    /*------------  插入图片-------------*/
    public void insertImage(@DrawableRes int imgId, int insertPosition, ImageSizeFlag sizeFlag, int[]... size) {
